...
var stack = (pushdownAutomata.initialStackSymbol != null ? [pushdownAutomata.initialStackSymbol] : []);
var input = "baabcbac";
var currentState = pushdownAutomata.initialState;
var history = [];
function getNextTransitionFunction() {
    ...
    pushdownAutomata.transitionFunction.forEach((value, index) => {
